                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="sm_data_col txtCtr">
                                                <table>
                                                    ...
                                                    @foreach($accountsX as $acx)
                                                        @if($acx->Budget_Appropriation_ID == $x->Budget_Appropriation_ID)
                                                        <tr>
                                                            <td>({{$acx->Account_Number}})-{{$acx->Account_Name}}</td>
                                                            <td>{{number_format((float)$acx->Appropriation_Amount, 2, '.', ',')}}</td>
                                                            <td><button class="delRec2" value="{{$acx->Budget_Appropriation_Accounts_ID}}" data-toggle="modal" data-target="#deleteFile2">Remove</button></td>
                                                        </tr>
                                                        @endif
                                                    @endforeach
                                                </table>
                                            ...
                                            <td class="sm_data_col txtCtr">
                                                ...
                                                <button class="delRec" value="{{$x->Budget_Appropriation_ID}}" data-toggle="modal" data-target="#deleteFile">Delete</button>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
            <form method="POST" action="{{ route('del_rec') }}"> @csrf
                ...
                <input id="del_ident" value="36" class="" name="del_ident" hidden>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
            <form method="POST" action="{{ route('del_rec') }}"> @csrf
                ...
                <input id="del_ident2" value="39" class="" name="del_ident" hidden>
