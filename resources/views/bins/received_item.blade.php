...
<div class="page_title_row col-md-12">
    <div class="col-md-6 titleXZ"> Recieved Item </div>
        ...
        <form id="newEntryXYZ" method="POST" action="{{ route('create_bins_received_item') }}" autocomplete="off" enctype="multipart/form-data">@csrf
            <div class="modal-body Absolute-Center">
                <div class="modal_input_container">
                    ...
                    <div class="up_marg5">
                        <span><b>Donation:</b></span><br>
                        <select class="modal_input1" name="donationX">
                    ...
                    <div class="up_marg5">
                        <span><b>Recieved By:</b></span><br>
                        <select class="modal_input1" name="rc_by">
                            <option value=1 hidden selected>Select</option>
                    ...
                    <div class="up_marg5">
                        <span><b>Received_Quantity:</b></span><br>
                        <input class="modal_input1" name="received_qty" type="number">
                    </div>
        ...
        <form id="updateEntryXYZ" method="POST" action="{{ route('update_bins_received_item') }}" autocomplete="off" enctype="multipart/form-data">@csrf
            <div class="modal-body Absolute-Center">
                <div class="modal_input_container">
                    ...
                    <input id="this_received_item_IdX" class="modal_input1" name="Received_Item_ID" hidden>
                    <div class="up_marg5">
                        <span><b>Item:</b></span><br>
                    ...
                    <div class="up_marg5">
                        <span><b>Donation:</b></span><br>
                        <select class="modal_input1" name="donationX2">
                    ...
                    <div class="up_marg5">
                        <span><b>Recieved By:</b></span><br>
                        <select class="modal_input1" name="rc_by2">
                    ...
                    <div class="up_marg5">
                        <span><b>Received_Quantity:</b></span><br>
                        <input id="this_received_qtyX" class="modal_input1" name="received_qty2" type="number">
                    </div>
                </div>
