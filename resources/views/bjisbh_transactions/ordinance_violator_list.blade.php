...
<script>
    ...
    $(document).on("change", "#B_ID", function() {
        ...
        $.ajax({
            type: "GET",
            url: "/get_ordinance_violator_list/" + Barangay_ID,
            fail: function() {
                alert("request failed");
            },
            success: function(data) {
                ...
                data.forEach(function(element) {
                    ...
                    $('#example').DataTable().row.add([
                        ...
                        element["Type_of_Penalties"],
                        element["Violation_Status"],
                        element["Vilotation_Date"],
                        "<a class='btn btn-success' href='ordinance_violator_details/" + element["Ordinance_Violators_ID"] + "'>Edit</a>",
                    ]).draw();
                });
            }
        });
