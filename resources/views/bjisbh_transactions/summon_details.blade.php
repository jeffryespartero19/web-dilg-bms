...
<div class="page_title_row col-md-12">
    <div class="col-md-6 titleXZ"> Summon Details </div>
    <div class="col-md-6 breadcrumbXZ">
        <ol class="breadcrumb">
            <a href="{{route('home')}}">
                <li>DILG_BMS / </li>
            </a>
            <li> &nbsp;Summon Details</li>
        </ol>
    </div>
</div>
@if ($errors->any())
...
<div class="tableX_row col-md-12 up_marg5">
    ...
    <br>
    <div class="col-md-12">
        <form id="newHousehold" method="POST" action="{{ route('create_summon') }}" autocomplete="off" enctype="multipart/form-data">
            @csrf
            <div class="row">
