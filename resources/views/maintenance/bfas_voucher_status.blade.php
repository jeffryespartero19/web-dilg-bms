...
<div class="page_title_row col-md-12">
    <div class="col-md-6 titleXZ"> Voucher Status Maintenance/Setup </div>
    <div class="col-md-6 breadcrumbXZ"> 
        <ol class="breadcrumb">
            <a href="{{route('home')}}"><li>DILG_BMS / </li></a>
            <li> &nbsp;bfas_voucher_status_maintenance</li>
        </ol> 
    </div>
</div>
        ...
        <form id="newEntryXYZ" method="POST" action="{{ route('create_bfas_voucher_status_maint') }}" autocomplete="off" enctype="multipart/form-data">@csrf
            <div class="modal-body Absolute-Center">
                <div class="modal_input_container">
                    <div class="up_marg5">
                        <span><b>Voucher Status:</b></span><br>
                        <input class="modal_input1" name="Voucher_Status">
                    </div>
        ...
        <form id="updateEntryXYZ" method="POST" action="{{ route('update_bfas_voucher_status_maint') }}" autocomplete="off" enctype="multipart/form-data">@csrf
            ...
            <div class="modal-body Absolute-Center">
                <div class="modal_input_container">
                    <div class="up_marg5">
                        <span><b>Voucher Status:</b></span><br>
                        <input id="this_voucher_status" class="modal_input1" name="Voucher_Status2">
                    </div>
