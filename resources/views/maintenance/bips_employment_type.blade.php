...
<div class="page_title_row col-md-12">
    <div class="col-md-6 titleXZ"> Employment Type Maintenance/Setup </div>
...
<div class="tableX_row col-md-12 up_marg5">
    <div class="flexer"> 
        ...
        <div class="twenty_split txtRight"><button data-toggle="modal" data-target="#createEmployment_Type">New</button></div>
    </div>
    <div class="col-md-12">
        ...
        <form id="newBRGY_Employment_Type" method="POST" action="{{ route('create_employment_type_maint') }}" autocomplete="off" enctype="multipart/form-data">@csrf
            <div class="modal-body Absolute-Center">
                <div class="modal_input_container">
                    <div class="up_marg5">
                        <span><b>Employment_Type:</b></span><br>
                        <input class="modal_input1" name="Employment_TypeX">
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn postThis_Employment_Type modal_sb_button">Create</button>
            </div>
        </form>
      </div>
...
<!-- Create Employment_Type END -->

<!-- Edit/Update Employment_Type Modal -->
        ...
        <form id="updateBRGY_Employment_Type" method="POST" action="{{ route('update_employment_type_maint') }}" autocomplete="off" enctype="multipart/form-data">@csrf
            <div class="modal-body Absolute-Center">
                <div class="modal_input_container">
                    <div class="up_marg5">
                        <span><b>Employment_Type:</b></span><br>
                        <input id="this_employment_type_idX" class="modal_input1" name="Employment_Type_idX" hidden>
                        <input id="this_employment_typeX" class="modal_input1" name="Employment_TypeX2">
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn updateThis_Employment_Type modal_sb_button">Save</button>
            </div>
        </form>
      </div>
...
<!-- Edit/Update Employment_Type END -->
