...
<div class="page_title_row col-md-12">
    <div class="col-md-6 titleXZ"> Account Type Maintenance/Setup </div>
    <div class="col-md-6 breadcrumbXZ"> 
        <ol class="breadcrumb">
            <a href="{{route('home')}}"><li>DILG_BMS / </li></a>
            <li> &nbsp;bfas_account_type_maintenance</li>
        </ol> 
    </div>
</div>
        ...
        <table class="table-bordered table_gen up_marg5">
            ...
            <tbody>
                @foreach($db_entries as $x)
                    <tr>
                        <td class="sm_data_col txtCtr">{{$x->Account_Type_ID}}</td>
            ...
            <div class="modal-body Absolute-Center">
                <div class="modal_input_container">
                    <div class="up_marg5">
                        ...
                        <input class="modal_input1" name="Account_Type">
                    </div>
        ...
        <form id="updateEntryXYZ" method="POST" action="{{ route('update_bfas_account_type_maint') }}" autocomplete="off" enctype="multipart/form-data">@csrf
            ...
            <div class="modal-body Absolute-Center">
                <div class="modal_input_container">
                    <div class="up_marg5">
                        <span><b>Account Type:</b></span><br>
                        <input id="this_account_type" class="modal_input1" name="Account_Type2">
                    </div>
