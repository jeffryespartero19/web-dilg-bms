...
<div class="page_title_row col-md-12">
    <div class="col-md-6 titleXZ"> Type of Fee Maintenance/Setup </div>
    <div class="col-md-6 breadcrumbXZ"> 
        <ol class="breadcrumb">
            <a href="{{route('home')}}"><li>DILG_BMS / </li></a>
            <li> &nbsp;bfas_type_of_fee_maintenance</li>
        </ol> 
    </div>
</div>
        ...
        <form id="newEntryXYZ" method="POST" action="{{ route('create_bfas_type_of_fee_maint') }}" autocomplete="off" enctype="multipart/form-data">@csrf
            <div class="modal-body Absolute-Center">
                <div class="modal_input_container">
                    <div class="up_marg5">
                        <span><b>Account_Information:</b></span><br>
                        <select class="modal_input1" name="Account_Information_IDX">
                    ...
                    <div class="up_marg5">
                        <span><b>Type_of_Fee:</b></span><br>
                        <input class="modal_input1" name="type_of_fee_X">
                    </div>

                    <div class="up_marg5">
                        <span><b>Amount:</b></span><br>
                        <input class="modal_input1" name="Amount_X" type="number" step=".01">
                    </div>
        ...
        <form id="updateEntryXYZ" method="POST" action="{{ route('update_bfas_type_of_fee_maint') }}" autocomplete="off" enctype="multipart/form-data">@csrf
            ...
            <div class="modal-body Absolute-Center">
                <div class="modal_input_container">
                    <div class="up_marg5">
                        <span><b>Account_Information:</b></span><br>
                        <select class="modal_input1" name="Account_Information_IDX2">
                    ...
                    <div class="up_marg5">
                        <span><b>Type_of_Fee:</b></span><br>
                        <input id="this_type_fee" class="modal_input1" name="type_of_fee_X2">
                    </div>

                    <div class="up_marg5">
                        <span><b>Amount:</b></span><br>
                        <input id="this_amount" class="modal_input1" name="Amount_X2" type="number" step=".01">
                    </div>
