...
<div class="page_title_row col-md-12">
    <div class="col-md-6 titleXZ"> Item Status Maintenance/Setup </div>
    <div class="col-md-6 breadcrumbXZ"> 
        <ol class="breadcrumb">
            <a href="{{route('home')}}"><li>DILG_BMS / </li></a>
            <li> &nbsp;bins_item_status_maintenance</li>
        </ol> 
    </div>
</div>
        ...
        <form id="newEntryXYZ" method="POST" action="{{ route('create_bins_item_status_maint') }}" autocomplete="off" enctype="multipart/form-data">@csrf
            <div class="modal-body Absolute-Center">
                <div class="modal_input_container">
                    <div class="up_marg5">
                        <span><b>item_Class:</b></span><br>
                        <input class="modal_input1" name="item_status_X">
                    </div>
            ...
            <div class="modal-body Absolute-Center">
                <div class="modal_input_container">
                    <div class="up_marg5">
                        ...
                        <input id="this_item_status_idX" class="modal_input1" name="item_status_ID" hidden>
                        <input id="this_item_statusX" class="modal_input1" name="item_status_X2">
                    </div>
