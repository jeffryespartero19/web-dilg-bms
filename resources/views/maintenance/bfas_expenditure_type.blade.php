...
<div class="page_title_row col-md-12">
    <div class="col-md-6 titleXZ"> Expenditure Type Maintenance/Setup </div>
    <div class="col-md-6 breadcrumbXZ"> 
        <ol class="breadcrumb">
            <a href="{{route('home')}}"><li>DILG_BMS / </li></a>
            <li> &nbsp;bfas_expenditure_type_maintenance</li>
        </ol> 
    </div>
</div>
            ...
            <div class="modal-body Absolute-Center">
                <div class="modal_input_container">
                    <div class="up_marg5">
                        ...
                        <input class="modal_input1" name="Expenditure_Type">
                    </div>
        ...
        <form id="updateEntryXYZ" method="POST" action="{{ route('update_bfas_expenditure_type_maint') }}" autocomplete="off" enctype="multipart/form-data">@csrf
            ...
            <div class="modal-body Absolute-Center">
                <div class="modal_input_container">
                    <div class="up_marg5">
                        <span><b>Expenditure Type:</b></span><br>
                        <input id="this_expenditure_type" class="modal_input1" name="Expenditure_Type2">
                    </div>
