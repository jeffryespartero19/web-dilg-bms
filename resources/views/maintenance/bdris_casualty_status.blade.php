...
<div class="page_title_row col-md-12">
    <div class="col-md-6 titleXZ"> Casualty Status Maintenance/Setup </div>
    <div class="col-md-6 breadcrumbXZ"> 
        <ol class="breadcrumb">
            <a href="{{route('home')}}"><li>DILG_BMS / </li></a>
            <li> &nbsp;casualty status</li>
        </ol> 
    </div>
</div>
<div class="tableX_row col-md-12 up_marg5">
    <div class="flexer"> 
        ...
        <div class="twenty_split txtRight"><button data-toggle="modal" data-target="#createCasualty_Status">New</button></div>
    </div>
    <div class="col-md-12">
        ...
        <form id="newBRGY_Casualty_Status" method="POST" action="{{ route('create_casualty_status_maint') }}" autocomplete="off" enctype="multipart/form-data">@csrf
            <div class="modal-body Absolute-Center">
                <div class="modal_input_container">
                    <div class="up_marg5">
                        <span><b>Casualty_Status:</b></span><br>
                        <input class="modal_input1" name="Casualty_StatusX">
                    </div>
        ...
        <form id="updateBRGY_Casualty_Status" method="POST" action="{{ route('update_casualty_status_maint') }}" autocomplete="off" enctype="multipart/form-data">@csrf
            <div class="modal-body Absolute-Center">
                <div class="modal_input_container">
                    <div class="up_marg5">
                        <span><b>Casualty_Status:</b></span><br>
                        <input id="this_casualty_status_idX" class="modal_input1" name="Casualty_Status_idX" hidden>
                        <input id="this_casualty_statusX" class="modal_input1" name="Casualty_StatusX2">
                    </div>
