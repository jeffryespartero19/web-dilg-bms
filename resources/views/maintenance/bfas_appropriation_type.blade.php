...
<div class="page_title_row col-md-12">
    <div class="col-md-6 titleXZ"> Appropriation Type Maintenance/Setup </div>
    <div class="col-md-6 breadcrumbXZ"> 
        <ol class="breadcrumb">
            <a href="{{route('home')}}"><li>DILG_BMS / </li></a>
            <li> &nbsp;bfas_appropriation_type_maintenance</li>
        </ol> 
    </div>
</div>
<div class="tableX_row col-md-12 up_marg5">
    ...
    <div class="col-md-12">
        <table class="table-bordered table_gen up_marg5">
            <thead>
                <tr>
                    <th>Appropriation <br>Type ID</th>
            ...
            <tbody>
                @foreach($db_entries as $x)
                    <tr>
                        <td class="sm_data_col txtCtr">{{$x->Appropriation_Type_ID}}</td>
        ...
        <form id="newEntryXYZ" method="POST" action="{{ route('create_bfas_appropriation_type_maint') }}" autocomplete="off" enctype="multipart/form-data">@csrf
            <div class="modal-body Absolute-Center">
                <div class="modal_input_container">
                    <div class="up_marg5">
                        <span><b>Appropriation Type:</b></span><br>
                        <input class="modal_input1" name="Appropriation_Type">
                    </div>
        ...
        <form id="updateEntryXYZ" method="POST" action="{{ route('update_bfas_appropriation_type_maint') }}" autocomplete="off" enctype="multipart/form-data">@csrf
            ...
            <div class="modal-body Absolute-Center">
                <div class="modal_input_container">
                    <div class="up_marg5">
                        <span><b>Appropriation Type:</b></span><br>
                        <input id="this_appropriation_type" class="modal_input1" name="Appropriation_Type2">
                    </div>
