...
<div class="page_title_row col-md-12">
    <div class="col-md-6 titleXZ"> Deceased Type Maintenance/Setup </div>
...
<div class="tableX_row col-md-12 up_marg5">
    <div class="flexer"> 
        ...
        <div class="twenty_split txtRight"><button data-toggle="modal" data-target="#createDeceased_Type">New</button></div>
    </div>
    <div class="col-md-12">
                ...
                @foreach($db_entries as $x)
                    <tr>
                        ...
                        <td class="sm_data_col txtCtr">
                            <button class="edit_deceased_type" value="{{$x->Deceased_Type_ID}}" data-toggle="modal" data-target="#updateDeceased_Type">Edit</button>
                        </td>
                    </tr>
                @endforeach
            </tbody>
        ...
        <form id="newBRGY_Deceased_Type" method="POST" action="{{ route('create_deceased_type_maint') }}" autocomplete="off" enctype="multipart/form-data">@csrf
            <div class="modal-body Absolute-Center">
                <div class="modal_input_container">
                    <div class="up_marg5">
                        <span><b>Deceased_Type:</b></span><br>
                        <input class="modal_input1" name="Deceased_TypeX">
                    </div>
        ...
        <form id="updateBRGY_Deceased_Type" method="POST" action="{{ route('update_deceased_type_maint') }}" autocomplete="off" enctype="multipart/form-data">@csrf
            <div class="modal-body Absolute-Center">
                <div class="modal_input_container">
                    <div class="up_marg5">
                        <span><b>Deceased_Type:</b></span><br>
                        <input id="this_deceased_type_idX" class="modal_input1" name="Deceased_Type_idX" hidden>
                        <input id="this_deceased_typeX" class="modal_input1" name="Deceased_TypeX2">
                    </div>
