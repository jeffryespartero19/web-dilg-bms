...
<div class="page_title_row col-md-12">
    <div class="col-md-6 titleXZ"> Family Position Maintenance/Setup </div>
    <div class="col-md-6 breadcrumbXZ"> 
        <ol class="breadcrumb">
            <a href="{{route('home')}}"><li>DILG_BMS / </li></a>
            <li> &nbsp;family position</li>
        </ol> 
    </div>
</div>
<div class="tableX_row col-md-12 up_marg5">
    <div class="flexer"> 
        ...
        <div class="twenty_split txtRight"><button data-toggle="modal" data-target="#createFamily_Position">New</button></div>
    </div>
    <div class="col-md-12">
        ...
        <form id="newBRGY_Family_Position" method="POST" action="{{ route('create_family_position_maint') }}" autocomplete="off" enctype="multipart/form-data">@csrf
            <div class="modal-body Absolute-Center">
                <div class="modal_input_container">
                    <div class="up_marg5">
                        <span><b>Family_Position:</b></span><br>
                        <input class="modal_input1" name="Family_PositionX">
                    </div>
        ...
        <form id="updateBRGY_Family_Position" method="POST" action="{{ route('update_family_position_maint') }}" autocomplete="off" enctype="multipart/form-data">@csrf
            <div class="modal-body Absolute-Center">
                <div class="modal_input_container">
                    <div class="up_marg5">
                        <span><b>Family_Position:</b></span><br>
                        <input id="this_family_position_idX" class="modal_input1" name="Family_Position_idX" hidden>
                        <input id="this_family_positionX" class="modal_input1" name="Family_PositionX2">
                    </div>
