...
<div class="page-border">
    <table style="width:100%;">
        <tr style="text-align: center;">
            <td style="font-size: 24px; font-weight:700;">List of Disaster Supplies</td>
        </tr>
    ...
    <table style="width:100%; border-top:1px solid black; border-bottom:1px solid black;border-collapse: collapse;">
        <thead>
            <tr>
                ...
                <th style="border:1px solid black;">Disaster Supplies Name</th>
                <th style="border:1px solid black;">Disaster Supplies Quantity</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="border:1px solid black; text-align:center">{{ $dtl->{"Disaster_Supplies_Name"} }}</td>
                <td style="border:1px solid black; text-align:center">{{ $dtl->{"Disaster_Supplies_Quantity"} }}</td>
