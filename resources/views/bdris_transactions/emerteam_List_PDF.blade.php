...
<div class="page-border">
    <table style="width:100%;">
        <tr style="text-align: center;">
            <td style="font-size: 24px; font-weight:700;">Emergency Team List</td>
        </tr>
        <!-- <tr style="text-align: center;">
    ...
    <table style="width:100%; border-top:1px solid black; border-bottom:1px solid black;border-collapse: collapse;">
        <thead>
            <tr>
                ...
                <th @if($chk_Emergency_Team_Hotline==0) class="hidden" @endif style="border:1px solid black;">Emergency Team Hotline</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td @if($chk_Emergency_Team_Hotline==0) class="hidden" @else class="sm_data_col" @endif>{{$x->Emergency_Team_Hotline}}</td>
