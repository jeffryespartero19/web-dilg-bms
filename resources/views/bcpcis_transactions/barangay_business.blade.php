...
<div class="page_title_row col-md-12"> 
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Create Barangay Business</h1>
                </div>
                <div class="col-sm-6">
                        ...
                        <div class="tableX_row col-md-12 up_marg5">
                            ...
                            <div class="col-md-12">
                                <form id="newBarangay_Business" method="POST" action="{{ route('create_barangay_business') }}" autocomplete="off" enctype="multipart/form-data">
                                    @csrf
                                    <div>
                                        <input type="text" class="form-control" id="Business_ID" name="Business_ID" hidden>
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-3" style="padding:0 10px">
                                                ...
                                                <input type="text" class="form-control" id="Business_Tin" name="Business_Tin">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-lg-3" style="padding:0 10px">
