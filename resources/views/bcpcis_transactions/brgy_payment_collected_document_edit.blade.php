...
<div class="page_title_row col-md-12">
    <div class="col-md-6 titleXZ"> Brgy Payment Collected (Document Information)</div> 
    <div class="col-md-6 breadcrumbXZ">
        <ol class="breadcrumb">
            <a href="{{route('home')}}">
                <li>DILG_BCPCIS / </li>
            </a> 
            <li> &nbsp;Brgy Payment Collected (Document Information)</li>
        </ol> 
    </div>
</div>
@if ($errors->any())
...
<div class="tableX_row col-md-12 up_marg5">
    <br>
    <div class="col-md-12">
        <form id="newBrgy_Document_Information" method="POST"  action="{{ route('create_barangay_payment_collected_docu') }}"  autocomplete="off" enctype="multipart/form-data">
            @csrf
            <div class="row">
                    ...
                    <div class="form-group col-lg-3" style="padding:0 10px">
                        ...
                        <select class="form-control" id="Document_ID" name="Document_ID">
                            <option value='' disabled selected>Select Option</option>
                                ...
                                <option value="{{ $bt1->Document_ID }}" {{ $bt1->Document_ID  == $payment_docu[0]->Document_ID  ? "selected" : "" }}>{{ $bt1->Transaction_No }}</option>
                                @endforeach
                        </select>
                    </div>
                    <div class="form-group col-lg-3" style="padding:0 10px">
                    ...
                    <div class="form-group col-lg-3" style="padding:0 10px">
                        <label for="Region_ID">Region</label>
                            <select class="form-control" id="Region_ID" name="Region_ID">
                                ...
                                <option value="{{ $bt1->Region_ID }}" {{ $bt1->Region_ID  == $payment_docu[0]->Region_ID  ? "selected" : "" }}>{{ $bt1->Region_Name }}</option>
                                @endforeach
                            </select>
                    </div>
                    <div class="form-group col-lg-3" style="padding:0 10px">
                        <label for="Province_ID">Province</label>
                            <select class="form-control" id="Province_ID" name="Province_ID">
                                ...
                                <option value="{{ $bt1->Province_ID }}" {{ $bt1->Province_ID  == $payment_docu[0]->Province_ID  ? "selected" : "" }}>{{ $bt1->Province_Name }}</option>
                                @endforeach
                            </select>
                    </div>
                    <div class="form-group col-lg-3" style="padding:0 10px">
                        <label for="City_Municipality_ID">City_Municipality</label>
                            <select class="form-control" id="City_Municipality_ID" name="City_Municipality_ID">
                                ...
                                <option value="{{ $bt1->City_Municipality_ID }}" {{ $bt1->City_Municipality_ID  == $payment_docu[0]->City_Municipality_ID  ? "selected" : "" }}>{{ $bt1->City_Municipality_Name }}</option>
                                @endforeach
                            </select>
                    </div>
                    <div class="form-group col-lg-3" style="padding:0 10px">
                        <label for="Barangay_ID">Barangay</label>
                            <select class="form-control" id="Barangay_ID" name="Barangay_ID">
                                ...
                                <option value="{{ $bt1->Barangay_ID }}" {{ $bt1->Barangay_ID  == $payment_docu[0]->Barangay_ID  ? "selected" : "" }}>{{ $bt1->Barangay_Name }}</option>
                                @endforeach
                            </select>
                    </div>
                </div>
